...
define(['core/ajax', 'core/templates', 'core/str'], function(Ajax, Templates, Str) {
     ...
     * @returns {Promise}
     */
    var searchArticles = function(term) {
        return Ajax.call([{
     ...
     */
    var showArticle = function(articleId, articleTitle, fullUrl) {
     ...
     * @returns {Promise}
     */
    var searchArticlesMulti = function(terms) {
     ...
     */
    var loadSuggestedArticles = function() {
     ...
     */
    var loadPageSuggestions = function() {
        var terms = getSearchTerms();
        if (!terms.length) {
            return;
        }
     ...
     * @param {Blob} file
     */
    var processScreenshotFile = function(file) {
     ...
     */
    var wireEvents = function(overlay) {
     ...
     * @returns {Promise}
     */
    var renderPassthroughButton = function() {
        return Templates.render('local_freshdesk/help_button', {
            label: strs.gethelp,
